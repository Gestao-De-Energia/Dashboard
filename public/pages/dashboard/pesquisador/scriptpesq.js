import { getAllUserCommentsByDate, getAllUserGeneralComments, getUser } from "../../../db/getters.js";
...
function loadDateCommentsIntoCharts(userComments) {
    const sections = [
        { section: "fotovoltaica", chart: chartFotovoltaica, options: optionsFotovoltaica },
        { section: "eolica", chart: chartEolica, options: optionsEolica },
        { section: "energiaxdemanda", chart: chartEnergiaXDemanda, options: optionsEnergiaXDemanda },
        { section: "desempenho", chart: chartDesempenho, options: optionsDesempenho },
        { section: "energiaxcompensacao", chart: chartEnergiaXCompensacao, options: optionsEnergiaXCompensacao },
